...
1. Create a parent issue in Jira with the spec title as the issue title and a summary of the spec as the description. Use the team and project specified below, or ask if not clear.
...
- Priority: 1=Must Have, 3=Should Have, 4=Could Have (default to 3 unless the spec says otherwise)
...
5. Add AI label to all Jira tickets created  e.g. (aiauthored)
